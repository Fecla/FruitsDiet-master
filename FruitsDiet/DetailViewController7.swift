...
class DetailViewController7: UIViewController, UITextFieldDelegate, OEEventsObserverDelegate {
    
    @IBOutlet weak var TextField7: UITextField!
    @IBOutlet weak var TextFieldButton7: UIButton!
    ...
    override func viewDidLoad() {
        ...
        loadOpenEars()
        if let fruit7 = fruit7 {
            navigationItem.title = fruit7.name7?.capitalizedString
            imageView.image = UIImage(named: fruit7.name7!.lowercaseString)
        }
    }
    ...
    @IBAction func TextFieldButton7(sender: AnyObject) {
        TextField7.resignFirstResponder()
        TextLabel7.text = TextField7.text
        
        if TextField7.text == navigationItem.title {
            TextField7.hidden = true
            heardTextView.backgroundColor = UIColor.greenColor()
            return (recordButton.alpha = 0.05)
        } else {
            TextField7.hidden = false
            heardTextView.backgroundColor = UIColor.redColor()
        }
        
    }
    
    func textFieldDidBeginEditing(TextField7: UITextField) {
        print("TextField did begin editing method called")
    }
    func textFieldDidEndEditing(TextField7: UITextField) {
        print("TextField did end editing method called")
    }
    func textFieldShouldBeginEditing(TextField7: UITextField) -> Bool {
        print("TextField should begin editing method called")
        return true
    }
    func textFieldShouldClear(TextField7: UITextField) -> Bool {
        print("TextField should clear method called")
        return true
    }
    func textFieldShouldEndEditing(TextField7: UITextField) -> Bool {
        print("TextField should snd editing method called")
        return true
    }
    func TextField7(TextField7: UITextField, shouldChangeCharactersInRange range: NSRange, replacementString string: String) -> Bool {
        print("While entering the characters this method gets called")
        return true
    }
    func textFieldShouldReturn(TextField7: UITextField) -> Bool {
