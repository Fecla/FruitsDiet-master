...
class DetailViewController3: UIViewController, UITextFieldDelegate, OEEventsObserverDelegate {

    @IBOutlet weak var TextField3: UITextField!
    @IBOutlet weak var TextFieldButton3: UIButton!
    ...
    override func viewDidLoad() {
        ...
        loadOpenEars()
        if let fruit3 = fruit3 {
            navigationItem.title = fruit3.name3?.capitalizedString
            imageView.image = UIImage(named: fruit3.name3!.lowercaseString)
        }
    }
    ...
    @IBAction func TextFieldButton3(sender: AnyObject) {
        TextField3.resignFirstResponder()
        TextLabel3.text = TextField3.text
        
        if TextField3.text == navigationItem.title {
    ...
    func textFieldDidBeginEditing(TextField3: UITextField) {
        print("TextField did begin editing method called")
    }
    func textFieldDidEndEditing(TextField3: UITextField) {
        print("TextField did end editing method called")
    }
    func textFieldShouldBeginEditing(TextField3: UITextField) -> Bool {
        print("TextField should begin editing method called")
        return true
    }
    func textFieldShouldClear(TextField3: UITextField) -> Bool {
        print("TextField should clear method called")
        return true
    }
    func textFieldShouldEndEditing(TextField3: UITextField) -> Bool {
        print("TextField should snd editing method called")
        return true
    }
    func TextField3(TextField3: UITextField, shouldChangeCharactersInRange range: NSRange, replacementString string: String) -> Bool {
        print("While entering the characters this method gets called")
        return true
    }
    func textFieldShouldReturn(TextField3: UITextField) -> Bool {
