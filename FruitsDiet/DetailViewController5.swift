...
class DetailViewController5: UIViewController, UITextFieldDelegate, OEEventsObserverDelegate {
    
    
    @IBOutlet weak var TextField5: UITextField!
    @IBOutlet weak var TextFieldButton5: UIButton!
    ...
    override func viewDidLoad() {
        ...
        loadOpenEars()
        if let fruit5 = fruit5 {
            navigationItem.title = fruit5.name5?.capitalizedString
            imageView.image = UIImage(named: fruit5.name5!.lowercaseString)
        }
    }
    ...
    @IBAction func TextFieldButton5(sender: AnyObject) {
        TextField5.resignFirstResponder()
        TextLabel5.text = TextField5.text
        
        // проверка условий на написание
        if TextField5.text == navigationItem.title {
    ...
    func textFieldDidBeginEditing(TextField5: UITextField) {
        print("TextField did begin editing method called")
    }
    func textFieldDidEndEditing(TextField5: UITextField) {
        print("TextField did end editing method called")
    }
    func textFieldShouldBeginEditing(TextField5: UITextField) -> Bool {
        print("TextField should begin editing method called")
        return true
    }
    func textFieldShouldClear(TextField5: UITextField) -> Bool {
        print("TextField should clear method called")
        return true
    }
    func textFieldShouldEndEditing(TextField5: UITextField) -> Bool {
        print("TextField should snd editing method called")
        return true
    }
    func TextField5(TextField5: UITextField, shouldChangeCharactersInRange range: NSRange, replacementString string: String) -> Bool {
        print("While entering the characters this method gets called")
        return true
    }
    func textFieldShouldReturn(TextField5: UITextField) -> Bool {
